...
if selected == "Flat Resale Price Prediction":
    ...
    if button:
        ...
        if not all([user_month,user_town,user_flat_type,user_flat_model,floor_area_sqm,price_per_sqm,year,block,
            ...
            user_data=np.array([[ flat_type, block, year, flat_model,remaining_lease_log, price_per_sqm_log,
                                 month, town,lease_commence_date, years_holding, floor_area_sqm_log, storey_start,
                                storey_end,  age_of_property ]])
